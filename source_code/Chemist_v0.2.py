...
def element_print():
    ...
    print("酸根(算作一种元素):OH(8.1)  SO₄(16.8)  SO₃(16.8.0)  CO₃(6.8) HCO₃(1.6.8) HSO₄(1.16.8) HSO₃(1.16.8.0) HNO₃(1.7.8) NH₄(7.1) ClO(17.8.0.1) ClO₂(17.8.0.2) ClO₃(17.8.0.3) ClO₄(17.8.0.4)")
def element_choic():
